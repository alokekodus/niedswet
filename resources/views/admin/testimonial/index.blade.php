...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <form class="modal-content" id="addTestimonialForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" accept="image/*" id="profile_pic" name="profile_pic">
                        </div>
        ...
        <div class="modal fade" id="updateTestimonialModal" data-bs-backdrop="static" tabindex="-1"
                ...
                <form class="modal-content" id="updateTestimonialForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_name" name="edit_name" value="Alok">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" rows="4" id="edit_message" name="edit_message">My message</textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" id="closeModalBtn" data-bs-dismiss="modal">
